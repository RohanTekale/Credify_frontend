...
// Single ThemeToggle — used once in desktop right-side and once in mobile row
...
const Navbar = () => {
  ...
  const navBg = scrolled
    ? isDark ? 'rgba(8,12,20,0.95)' : 'rgba(240,243,255,0.97)'
    : isDark ? 'rgba(8,12,20,0.5)'  : 'rgba(240,243,255,0.8)';

  const navBorder = scrolled
    ? isDark ? 'rgba(255,255,255,0.07)' : 'rgba(59,97,245,0.12)'
    : 'transparent';
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
              ...
              >
                ...
                {isActive(link.path) && (
                  <span style={{
                    ...
                    width:4, height:4, borderRadius:'50%', background:'var(--brand-400)',
                  }} />
                )}
              </button>
            ))}
            ...
            {user && isAdmin && (
              <button
                ...
                style={{
                  ...
                  fontSize:13, fontWeight:700, fontFamily:'Sora,sans-serif', transition:'all 200ms',
                }}
          ...
          {/* Desktop Right: theme toggle + auth — ONLY shown on desktop */}
              ...
              <>
                <button
                  ...
                  style={{
                    ...
                    color:'var(--text-secondary)', padding:'8px 14px', borderRadius:8, transition:'all 150ms',
                  }}
          ...
          {/* Mobile: theme toggle + hamburger — ONLY shown on mobile (md:hidden) */}
        ...
        {mobileOpen && (
          <div style={{
            padding:16,
            background: isDark ? 'rgba(8,12,20,0.98)' : 'rgba(240,243,255,0.98)',
            ...
            {navLinks.map((link) => (
              <button key={link.path} onClick={() => navigate(link.path)} style={{
                ...
                fontFamily:'Sora,sans-serif', fontWeight:600, transition:'all 150ms',
              }}>{link.label}</button>
            ))}
            ...
            {user && isAdmin && (
              <button onClick={() => navigate('/dev')} style={{
                display:'flex', alignItems:'center', gap:8, width:'100%',
                padding:'10px 14px', marginBottom:2, borderRadius:10,
                background:'rgba(59,97,245,0.08)', color:'var(--brand-400)',
                border:'1px solid rgba(59,97,245,0.15)', cursor:'pointer',
                fontSize:14, fontFamily:'Sora,sans-serif', fontWeight:700,
              }}>
                <Terminal size={15}/>
                Dev Panel
